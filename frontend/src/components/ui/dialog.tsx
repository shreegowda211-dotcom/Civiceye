...
// Context to coordinate description presence and id between Content and Description
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        <DialogContext.Provider value={{ descriptionId, setHasDescription }}>
          {children}
...
>(({ className, ...props }, ref) => {
  ...
  const id = props.id || ctx?.descriptionId;
